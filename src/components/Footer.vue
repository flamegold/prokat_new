<template>
  <div class="bg-[#1A1A1A] lg:pt-20 pt-6 lg:pb-20 pb-10 text-white">
      ...
      <div class = "grid lg:grid-cols-4 grid-cols-1 gap-y-6 justify-center items-center lg:px-10">
        ...
        <div>
          <ul class = "text-xl lg:text-base">
            ...
            <li class = "uppercase mb-2"><a href="#faq" class = "hover:text-[#0CF;]">FAQ</a></li>
            <li class = "uppercase mb-2"><a href="#contacts" class = "hover:text-[#0CF;]">Как добраться?</a></li>
        ...
        <div class = "">
          ...
          </svg></a><a href="https://vk.com/enottmn">prokat_enot_tmn</a></li>
          <li class = "flex items-center gap-5 mb-2">
              <a href="https://www.instagram.com/prokat_enot_tmn/">
   ...
   <path d="M16.5 7.5l0 .01"></path>
</svg></a> <a href="https://www.instagram.com/prokat_enot_tmn/">prokat_enot_tmn</a></li>
          <li class = "flex items-center gap-5 mb-2">
            <a href="https://wa.me/79323217213"><svg xmlns="http://www.w3.org/2000/svg"
            class="text-[#00CCFF] icon icon-tabler icon-tabler-brand-whatsapp cursor-pointer"
            width="35" height="35" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
            stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
          ...
          </svg></a> <a href="https://wa.me/79323217213">prokat_enot_tmn</a></li>
          <li class = "flex items-center gap-5 mb-2">
            <a href="https://t.me/+79323217213"><svg xmlns="http://www.w3.org/2000/svg"
            class="text-[#00CCFF] icon icon-tabler icon-tabler-brand-telegram cursor-pointer"
            width="35" height="35" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
            stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            <path d="M15 10l-4 4l6 6l4 -16l-18 7l4 2l2 6l3 -4"></path>
          </svg></a><a href="https://t.me/+79323217213">prokat_enot_tmn</a></li>
          </ul>
        </div>
        <div>
